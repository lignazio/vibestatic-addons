<?php
/**
 * Plugin Name:       VibeStatic Add-on: BunnyCDN Deployment
 * Plugin URI:        https://github.com/lignazio/vibestatic-addon-bunnycdn
...
function renderMissingCoreNotice() : void {
    ...
    printf(
        ...
        esc_html__(
            'The VibeStatic BunnyCDN add-on needs the VibeStatic plugin, which is not active.',
            'vibestatic'
        )
    );
}
