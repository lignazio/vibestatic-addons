<?php
/**
 * Plugin Name:       VibeStatic Add-on: Cloudflare Workers KV Deployment
 * Plugin URI:        https://github.com/lignazio/vibestatic-addon-cloudflare-workers
...
function renderMissingCoreNotice() : void {
    ...
    printf(
        ...
        esc_html__(
            'The VibeStatic Cloudflare Workers add-on needs the VibeStatic plugin, which is not active.',
            'vibestatic'
        )
    );
}
