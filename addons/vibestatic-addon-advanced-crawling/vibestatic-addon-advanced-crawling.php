 ...
 * Plugin URI:        https://github.com/lignazio/vibestatic-addon-advanced-crawling
...
function renderMissingCoreNotice() : void {
    ...
    printf(
        ...
        esc_html__(
            'The VibeStatic Additional Host Rewriting add-on needs the VibeStatic plugin, which is not active.',
            'vibestatic'
        )
    );
}
