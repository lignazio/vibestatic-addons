<?php
/**
 * Plugin Name:       VibeStatic Add-on: Google Cloud Storage Deployment
 * Plugin URI:        https://github.com/lignazio/vibestatic-addon-gcs
...
function renderMissingCoreNotice() : void {
    ...
    printf(
        ...
        esc_html__(
            'The VibeStatic Google Cloud Storage add-on needs the VibeStatic plugin, which is not active.',
            'vibestatic'
        )
    );
}
